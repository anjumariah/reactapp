...
// const state = useSelector((state:StateProp) => state.authReducerItem.adminInfo);
...
//       axios.post('http://localhost:3000/auth/login',loginData,{headers:{"x-access-token":"tljahod"}})
//       .then((res) => {
//         console.log(res);
//         if(!res.data.auth){
